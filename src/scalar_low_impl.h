...
SECP256K1_INLINE void secp256k1_scalar_clear(secp256k1_scalar *r) { *r = 0; }
SECP256K1_INLINE void secp256k1_scalar_set_int(secp256k1_scalar *r, unsigned int v) { *r = v; }
...
SECP256K1_INLINE int secp256k1_scalar_check_overflow(const secp256k1_scalar *a) { return *a >= EXHAUSTIVE_TEST_ORDER; }
